document.addEventListener("DOMContentLoaded", function() {
  ...
  // CORRECTED: Calculate daily average session time - FIXED to use ALL sessions from today
  ...
  // CORRECTED: Calculate weekly average session time - FIXED to use proper weekly aggregation
  ...
  function updateStatistics(sessions) {
    try {
      ...
      document.getElementById('avg-weekly').textContent = formatDuration(weeklyAvgSeconds);
      ...
      console.log(`📈 Final Results - Daily: ${formatDuration(dailyAvgSeconds)}, Weekly: ${formatDuration(weeklyAvgSeconds)}`);
