...
function updateAverageRating() {
  ...
  // Sum all ratings across all brands
  Object.values(ratingsData.brands).forEach(brand => {
    totalSum += brand.total;  // brand.total is already the sum of all ratings for this brand
...
// UPDATED: Update popular brand based on highest average rating
function updatePopularShade() {
  ...
  // Iterate over each brand to find the one with highest average rating
